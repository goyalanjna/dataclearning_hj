...
#
# OVERVIEW
#   Worked for Cleansing  the data and downloaded the final data into file 
# named "tidy_data.txt".
...
zipUrl_an <- "https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip"
zipFile_an <- "UCI HAR Dataset.zip"

if (!file.exists(zipFile_an)) {
  download.file(zipUrl_an, zipFile_an, mode = "wb")
}
